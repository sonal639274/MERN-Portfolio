...
import AddClientProject from "./sub-components/AddClientProject";
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                    active === "Add Client Project"
                      ? "text-accent-foreground bg-accent"
                      : "text-muted-foreground"
                  }  transition-colors hover:text-foreground md:h-8 md:w-8`}
                  onClick={() => setActive("Add Client Project")}
                >
                 <LayoutGrid className="h-5 w-5" />
                  <span className="sr-only">Add Client Project</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">Add Client Project</TooltipContent>
            </Tooltip>
          </TooltipProvider>
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
        ...
        <div className="flex items-center gap-4 md:grow-0 sm:ml-16 sm:mt-5 padding-left">
          <img
