...
const Contact = (props) => {
  ...
  const handleMessage = async (e) => {
    ...
    await axios
      .post(
        props.backend_URL+"/api/v1/message/send",
    ...
    <>
      <div className="overflow-x-hidden">
        <div className="relative mb-8">
          ...
          >
            CONTACT
            <span className="text-tubeLight-effect font-extrabold none">ME</span>
          </h1>
        ...
        <div className="contact-info">
          <div className="info-div">
            <h2 className="heading"><span className="span">Phone</span></h2>
            <p className="para">+91 6392740132</p>
          </div>
          <div className="info-div">
            <h2 className="heading"><span className="span">Mail</span></h2>
            <p className="para">sonal639274@gamil.com</p>
          </div>
          <div className="info-div">
            <h2 className="heading"><span className="span">Address</span></h2>
            <p className="para">New Ashok Nagar, Delhi 110096</p>
          </div>
        </div>
